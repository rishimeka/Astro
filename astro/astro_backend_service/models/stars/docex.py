...
from astro_backend_service.models.stars.base import OrchestratorStar

if TYPE_CHECKING:
    from astro_backend_service.executor.context import ExecutionContext
    from astro_backend_service.models.outputs import DocExResult
...
class DocExStar(OrchestratorStar):
    ...
    async def execute(self, context: "ExecutionContext") -> "DocExResult":
        ...
        from astro_backend_service.models.outputs import DocExResult, DocumentExtraction
