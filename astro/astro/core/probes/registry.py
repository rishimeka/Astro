...
class ProbeRegistry:
    ...
    This is a class-level singleton registry - all probes are stored in
    a class variable that persists across the application lifetime.

    Example:
        # Register probes (happens automatically with @probe decorator)
        @probe
        ...
        # Look up probes
        probe = ProbeRegistry.get("search_web")
